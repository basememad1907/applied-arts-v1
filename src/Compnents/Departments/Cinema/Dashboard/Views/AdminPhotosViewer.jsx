...
export default function AdminsPhotosViewer(){
    ...
    async function getDataFromApi() {
        try {
            const { data } = await Axios.get(`https://applied-of-art.onrender.com/api/v1/uploads/gallery`, {
                headers: {
    ...
    const FilterProjects = projectData.filter((p) => p.department ==='6625929ccf34345d4b8ad156');
    useEffect(() => {
        getDataFromApi();
    }, []);
