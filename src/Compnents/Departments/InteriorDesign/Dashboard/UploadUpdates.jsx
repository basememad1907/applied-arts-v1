...
export default function UploadResearches({userData}) {
  ...
  const [research, setResearch] = useState({
    name: "",
    file: null,
    department:'6625921acf34345d4b8ad152'
  });
...
const FilterResearch = researchContainer.filter((p) => p.departmentId ==='6625921acf34345d4b8ad152');
useEffect(() => {
    GetDataFromApi();
}, []);
  ...
  const AddResearch = async (e) => {
    ...
    body.append("departmentId", "6625921acf34345d4b8ad152");
        ...
        <div key={index} className={`${styles.card} card`}>
          ...
          <div className={`${styles.cardBody} card-body`}>
            ...
            <button
              ...
              onClick={(e)=>deleteProject(research._id)}>
                <i class={`fa-regular fa-trash-can ${styles.trash}`} style={{color: "#d70404",}}></i>  
            </button>
