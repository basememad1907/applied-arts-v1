...
import image from "./imgs/product1.jpg";
import { Modal } from 'react-bootstrap';
import { motion } from 'framer-motion';

export default function HomeGalleryViews() {
    ...
    return (
        <div className="col">
            <div className="col">
                {(projectData.length === 0 && !selectedProject) ? (
                    ...
                    <div className={styles.Holder}>
                        <section className={styles.Home}>
                            ...
                            {[...projectData].reverse().slice(0, 4).map((project, i) => (
